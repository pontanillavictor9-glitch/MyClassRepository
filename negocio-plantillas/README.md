...
└── ventas/
    ├── pagina-de-venta.md    ← Textos listos para la página de venta
    ├── guia-de-lanzamiento.md ← Pasos exactos para publicar y cobrar (~20 min)
    └── promocion-redes.md    ← Mensajes listos para WhatsApp, Facebook y TikTok
```

## El producto (ya construido y verificado)

| # | Plantilla | Qué resuelve |
|---|-----------|--------------|
| 1 | Control de Inventario | Stock en tiempo real, alertas de reposición, valor del inventario |
...
## Tu única tarea (una sola vez, ~20 minutos)

1. Abre `ventas/guia-de-lanzamiento.md` y sigue los pasos.
2. Crea la cuenta gratis en Gumroad o Hotmart (tiene que estar a tu nombre para
   que te paguen a ti).
3. Sube el ZIP, pega los textos de `pagina-de-venta.md`, pon el precio sugerido.
4. Comparte los mensajes de `promocion-redes.md`.

Después de eso, la plataforma cobra, entrega el archivo y te deposita
automáticamente. El precio sugerido y la estrategia están en la guía.
